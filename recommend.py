...
def read_movie_title(fname):   
    with open(fname) as f:
        for line in f.readlines():
            ...
            movie_titles_map[movie_id] = parts[1]

def get_ratings_map(fname):
    with open(fname) as f:
        for line in f.readlines():
            parts = [x.strip() for x in line.split(',')]
            movie_title_id = int(float(parts[1]))
...
movie_titles_filename="C:/Users/Keerthi Priya/Desktop/semester notes/sem-6/WT-2/project/final/tourist_spots.txt"
ratings_filename="C:/Users/Keerthi Priya/Desktop/semester notes/sem-6/WT-2/project/final/file2.txt"
...
def recommendation(active_user, K):
    ...
    for movie in recommended_movies:
        result.append(movie_titles_map[movie[0]])
    return result    

try:
    result = recommendation(int(sys.argv[1]),int(sys.argv[2]))
    for i in result:
        print(i)
